...
//   runApp(CreateReport());
// }
class Appliance3 extends StatefulWidget {
  @override
  _Appliance2State createState() => _Appliance2State();
}

class _Appliance2State extends State<Appliance3> {
  late String userId;
  String emailAdd = '';
...
class _ApplianceDetailsState extends State<ApplianceDetails> {
  ...
  void _getInitialValues() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? type2 = prefs.getString('type3');
    String? manafacturer2 = prefs.getString('manafacturer3');
    String? model2 = prefs.getString('model3');
    String? ownedBy2 = prefs.getString('ownedBy3');
    String? applianceInspect2 = prefs.getString('applianceInspect3');
    String? flueType2 = prefs.getString('flueType3');
    if (type2 != null) {
      setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          String isApp3Use = isApp3Used.toString();
                          ...
                          prefs.setString('type3', type);
                          prefs.setString('location3', loc);
                          prefs.setString('manafacturer3', mana);
                          prefs.setString('model3', model);
                          prefs.setString('ownedBy3', ownedBy);
                          prefs.setString(
                              'applianceInspect3', applianceInspect);
                          prefs.setString('flueType3', flueType);
                          prefs.setBool('isApp3Used', isApp3Used);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) =>
                                      Appliance3Inspection()));
                        },
