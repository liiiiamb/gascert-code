...
//   runApp(CreateReport());
// }
class Appliance2 extends StatefulWidget {
  @override
  _Appliance2State createState() => _Appliance2State();
}

class _Appliance2State extends State<Appliance2> {
  late String userId;
  String emailAdd = '';
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          String isApp2Use = isApp2Used.toString();
                          ...
                          prefs.setString('type2', type);
                          prefs.setString('location2', loc);
                          prefs.setString('manafacturer2', mana);
                          prefs.setString('model2', model);
                          prefs.setString('ownedBy2', ownedBy);
                          prefs.setString(
                              'applianceInspect2', applianceInspect);
                          prefs.setString('flueType2', flueType);
                          prefs.setBool('isApp2Used', isApp2Used);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) =>
                                      Appliance2Inspection()));
                        },
