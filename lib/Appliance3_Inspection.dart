...
import 'package:gascert/Appliance3_Combustion.dart';
...
class Appliance3Inspection extends StatefulWidget {
  @override
  _ApplianceInspectionState createState() => _ApplianceInspectionState();
}

class _ApplianceInspectionState extends State<Appliance3Inspection> {
  ...
  void _getInitialValues() async {
    ...
    String? opPress = prefs.getString('opPress3');
    String? safetyCorrect = prefs.getString('safetyCorrect3');
    String? satisfactory = prefs.getString('satisfactory3');
    String? visual = prefs.getString('visual3');
    String? termination = prefs.getString('termination3');
    String? fluePerformance = prefs.getString('fluePerformance3');
    String? applianceService = prefs.getString('applianceService3');
    String? applianceSafe = prefs.getString('applianceSafe3');
    if (visual != null) {
      setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('opPress3', opPress);
                          prefs.setString('safetyCorrect3', safetyCorrect);
                          prefs.setString('satisfactory3', satisfactory);
                          prefs.setString('visual3', visual);
                          prefs.setString('termination3', termination);
                          prefs.setString('fluePerformance3', fluePerformance);
                          prefs.setString(
                              'applianceService3', applianceService);
                          prefs.setString('applianceSafe3', applianceSafe);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) =>
                                      Appliance3Combustion()));
                        },
