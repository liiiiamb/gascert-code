...
class ApplianceActions extends StatefulWidget {
  @override
  _ApplianceActionsState createState() => _ApplianceActionsState();
}

class _ApplianceActionsState extends State<ApplianceActions> {
            ...
            Center(
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  prefs.setString('defects', defects);
                  prefs.setString('remedial', remedial);
                  prefs.setString('warningNotice', warningNotice);
