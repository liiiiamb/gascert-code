...
class Appliance3Combustion extends StatefulWidget {
  @override
  _ApplianceCombustionState createState() => _ApplianceCombustionState();
}

class _ApplianceCombustionState extends State<Appliance3Combustion> {
  ...
  void _getInitialValues() async {
    ...
    String? CO1_2 = prefs.getString('CO1_3');
    String? CO2_2 = prefs.getString('CO2_3');
    String? ratio_2 = prefs.getString('ratio_3');
    String? CO1_2_2 = prefs.getString('CO1_2_3');
    String? CO2_2_2 = prefs.getString('CO2_2_3');
    String? ratio_2_2 = prefs.getString('ratio_2_3');
    if (ratio_2 != null) {
      setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('CO1_3', CO1);
                          prefs.setString('CO2_3', CO2);
                          prefs.setString('ratio_3', ratio);
                          prefs.setString('CO1_2_3', CO1_2);
                          prefs.setString('CO2_2_3', CO2_2);
                          prefs.setString('ratio_2_3', ratio_2);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => Appliance3Actions()));
                        },
