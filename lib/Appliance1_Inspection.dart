...
class ApplianceInspection extends StatefulWidget {
  @override
  _ApplianceInspectionState createState() => _ApplianceInspectionState();
}

class _ApplianceInspectionState extends State<ApplianceInspection> {
                  ...
                  children: [
                    GestureDetector(
                        onTap: () async {
                          ...
                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => ApplianceDetails()));
                        },
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('opPress', opPress);
                          prefs.setString('safetyCorrect', safetyCorrect);
                          prefs.setString('satisfactory', satisfactory);
                          prefs.setString('visual', visual);
                          prefs.setString('termination', termination);
                          prefs.setString('fluePerformance', fluePerformance);
                          prefs.setString('applianceService', applianceService);
                          prefs.setString('applianceSafe', applianceSafe);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => ApplianceCombustion()));
                        },
