...
class Appliance2Combustion extends StatefulWidget {
  @override
  _ApplianceCombustionState createState() => _ApplianceCombustionState();
}

class _ApplianceCombustionState extends State<Appliance2Combustion> {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('CO1_2', CO1);
                          prefs.setString('CO2_2', CO2);
                          prefs.setString('ratio_2', ratio);
                          prefs.setString('CO1_2_2', CO1_2);
                          prefs.setString('CO2_2_2', CO2_2);
                          prefs.setString('ratio_2_2', ratio_2);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => Appliance2Actions()));
                        },
