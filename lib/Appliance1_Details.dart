...
//   runApp(CreateReport());
// }
class Appliance1 extends StatefulWidget {
  @override
  _Appliance1State createState() => _Appliance1State();
}

class _Appliance1State extends State<Appliance1> {
  late String userId;
  String emailAdd = '';
  ...
  void _getInitialValues() async {
    ...
    if (type != null) {
      setState(() {
        ...
        ManafacturerController.text = manafacturer!;
        ModelController.text = model!;
        OwnedByController.text = ownedBy!;
        ApplianceInspectController.text = applianceInspect!;
        FlueTypeController.text = flueType!;
      });
    }
    if (ownedBy == "Yes") {
      setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          String isApp1Use = isApp1Used.toString();
                          ...
                          prefs.setBool('isApp1Used', isApp1Used);
