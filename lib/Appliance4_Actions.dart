...
class Appliance4Actions extends StatefulWidget {
  @override
  _ApplianceActionsState createState() => _ApplianceActionsState();
}

class _ApplianceActionsState extends State<Appliance4Actions> {
  ...
  void _getInitialValues() async {
    ...
    String? defects = prefs.getString('defects4');
    String? remedial = prefs.getString('remedial4');
    String? warningNotice = prefs.getString('warningNotice4');
    if (remedial != null) {
      setState(() {
            ...
            Center(
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  prefs.setString('defects4', defects);
                  prefs.setString('remedial4', remedial);
                  prefs.setString('warningNotice4', warningNotice);
