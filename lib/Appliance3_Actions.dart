...
class Appliance3Actions extends StatefulWidget {
  @override
  _ApplianceActionsState createState() => _ApplianceActionsState();
}

class _ApplianceActionsState extends State<Appliance3Actions> {
  ...
  void _getInitialValues() async {
    ...
    String? defects = prefs.getString('defects3');
    String? remedial = prefs.getString('remedial3');
    String? warningNotice = prefs.getString('warningNotice3');
    if (remedial != null) {
      setState(() {
            ...
            Center(
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  prefs.setString('defects3', defects);
                  prefs.setString('remedial3', remedial);
                  prefs.setString('warningNotice3', warningNotice);
