...
import 'package:gascert/Appliance4_Combustion.dart';
...
class Appliance4Inspection extends StatefulWidget {
  @override
  _ApplianceInspectionState createState() => _ApplianceInspectionState();
}

class _ApplianceInspectionState extends State<Appliance4Inspection> {
  ...
  void _getInitialValues() async {
    ...
    String? opPress = prefs.getString('opPress4');
    String? safetyCorrect = prefs.getString('safetyCorrect4');
    String? satisfactory = prefs.getString('satisfactory4');
    String? visual = prefs.getString('visual4');
    String? termination = prefs.getString('termination4');
    String? fluePerformance = prefs.getString('fluePerformance4');
    String? applianceService = prefs.getString('applianceService4');
    String? applianceSafe = prefs.getString('applianceSafe4');
    if (visual != null) {
      setState(() {
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('opPress4', opPress);
                          prefs.setString('safetyCorrect4', safetyCorrect);
                          prefs.setString('satisfactory4', satisfactory);
                          prefs.setString('visual4', visual);
                          prefs.setString('termination4', termination);
                          prefs.setString('fluePerformance4', fluePerformance);
                          prefs.setString(
                              'applianceService4', applianceService);
                          prefs.setString('applianceSafe4', applianceSafe);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) =>
                                      Appliance4Combustion()));
                        },
