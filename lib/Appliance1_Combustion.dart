...
class ApplianceCombustion extends StatefulWidget {
  @override
  _ApplianceCombustionState createState() => _ApplianceCombustionState();
}

class _ApplianceCombustionState extends State<ApplianceCombustion> {
  ...
  void _getInitialValues() async {
    ...
    if (ratio != null) {
      setState(() {
        coController1.text = CO1!;
        co2Controller1.text = CO2!;
        ratioController1.text = ratio!;
        coController2.text = CO1_2!;
        co2Controller2.text = CO2_2!;
        ratioController2.text = ratio_2!;
      });
    }
  }
                  ...
                  children: [
                    GestureDetector(
                        onTap: () async {
                          ...
                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => ApplianceInspection()));
                        },
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          SharedPreferences prefs =
                              await SharedPreferences.getInstance();
                          prefs.setString('CO1', CO1);
                          prefs.setString('CO2', CO2);
                          prefs.setString('ratio', ratio);
                          prefs.setString('CO1_2', CO1_2);
                          prefs.setString('CO2_2', CO2_2);
                          prefs.setString('ratio_2', ratio_2);

                          Navigator.push(
                              context,
                              CupertinoPageRoute(
                                  builder: (context) => ApplianceActions()));
                        },
